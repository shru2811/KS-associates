  ...
  return (
    <div className="overflow-x-hidden">
      ...
      className="relative min-h-[500px]" style={{ background: 'linear-gradient(to right, #a8e6e6, #c1e6a6)' }}>
        ...
        <button className="hidden lg:block fixed right-0 top-1/4 -translate-y-1/2 bg-[#50bfbf] text-white text-lg py-3 px-4 rounded-lg transform -rotate-90 translate-x-8 z-50">
        <NavLink to='./contact'>
                    Contact Us
                  </NavLink>
        </button>
